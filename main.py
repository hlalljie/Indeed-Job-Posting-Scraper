...
def main():
    ...
    #single url test
    #url_root_list = ["https://www.indeed.com/jobs?q=python&l=Seattle%2C+WA&sc=0kf%3Aattr%28FCGTU%7CHFDVW%7CQJZM9%7CUTPWG%252COR%29attr%28X62BT%29explvl%28ENTRY_LEVEL%29%3B&vjk=0087ce71a8431337"]
...
def find_all_jobs_for_search(url_root, all_jobs, hard_limit):
    page_start = 0
    run_limit = {"max_job_count": 10, "hard_limit": hard_limit}
